...
$datas = query_data("SELECT*FROM db_skpd");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data SKPD</h1>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <button class="btn btn-sm btn-danger mb-1" data-bs-toggle="modal" data-bs-target="#modalDelete<?= $data['id']; ?>">Hapus</button>
                                                    </td>
                                                    <!-- Start update modal -->
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form role="form" action="" method="POST" autocomplete="off">
                                                                        <?php
                                                                        $id = $data['id'];
                                                                        $edits = query_data("SELECT * FROM db_skpd WHERE id='$id'");
                                                                        foreach ($edits as $edit) :
                                                                        ?>
                                                                            <input type="hidden" name="id" value="<?= $edit['id']; ?>">
                                                                            <p>Yakin untuk menghapus skpd ?</p>
            ...
            echo '
                <script type="text/javascript">
                    swal({
                        ...
                        if(isConfirm){
                            window.location.replace("data_skpd.php");
                        }
                    });
                </script>
            ';
